...
export default function Section1() {
  ...
  <div className="flex justify-center ">
    <div className="h-[4.5rem] w-[75rem] flex items-center justify-between bg-white rounded-full mt-[30px]">
      <div className="flex flex-row justify-center items-center ml-3 text-black">
        ...
        <div className={`${pop.className} text-black font-semibold ml-3 text-[18px]`}>
          Coffee Bucks
        </div>
        <div className="flex flex-row gap-x-9 ml-32 text-[17px] items-center">
          <div className="hover:text-[#01816f] cursor-pointer">Home</div>
          <div className="hover:text-[#01816f] cursor-pointer">Features</div>
          <div className="hover:text-[#01816f] cursor-pointer">How it Works</div>
          <div className="hover:text-[#01816f] cursor-pointer">About us</div>
          <div className="hover:text-[#01816f] cursor-pointer">Testimonial</div>
  ...
  <div className="flex flex-row justify-between ">
    ...
    <div className="flex flex-col ml-[14vh] mt-[32vh]">
      ...
      <div className={`${rale.className} text-[24px]`}>Active Users</div>
      {/* row start */}
      <div className="flex flex-row relative mt-3">
        <div className="bg-white h-[8vh] w-[8vh] rounded-full absolute">
          <Image src={"/man2.png"} alt={"man"} height={100} width={100} className="rounded-full w-[7vh] h-[7vh] ml-1 mt-1" />
        </div>
        <div className="bg-white h-[8vh] w-[8vh] rounded-full ml-8 absolute">
          <Image src={"/man1.png"} alt={"man"} height={100} width={100} className="rounded-full w-[7vh] h-[7vh] ml-1 mt-1" />
        </div>
        <div className="bg-white h-[8vh] w-[8vh] rounded-full ml-[70px] absolute">
          <Image src={"/family1.png"} alt={"man"} height={100} width={100} className="rounded-full w-[7vh] h-[7vh] ml-1 mt-1" />
        </div>
        <div className="bg-white h-[8vh] w-[8vh] rounded-full ml-[105px] absolute">
          <Image src={"/women1.png"} alt={"man"} height={100} width={100} className="rounded-full w-[7vh] h-[7vh] ml-1 mt-1" />
        </div>
    ...
    <div className="flex flex-col mt-[12vh] items-center">
      ...
      <div className={`${pop.className} text-white font-semibold text-[10vh] leading-tight mt-7`}>
    ...
    <div className="mr-[6rem] mt-[10vh]">
      <Image src={"/coffee_circle.png"} alt={"coffee"} width={4000} height={100} className="size-32" />
    </div>
    {/* Circle image end*/}
  </div>
  {/* row end */}
  ...
  <div className="flex flex-row">
    <Image src={"/dot_lines.png"} alt={"spring"} height={100} width={4000} className="w-[14vh] h-[17vh] ml-[6rem] mt-[40vh]" />

    <div className="flex justify-center space-x-16">
      <Image src={"/screen1.png"} alt={"screen1"} height={100} width={4000} className="h-[76vh] mt-[15vh] w-[43vh]" />
      <Image src={"/screen2.png"} alt={"screen2"} height={100} width={4000} className="h-[83vh] mt-[4.4vh] w-[48vh]" />
      {/* screen3 container */}
      <div className="relative">
        <Image src={"/screen3.png"} alt={"screen3"} height={100} width={4000} className="h-[76vh] mt-[11.3vh] w-[43vh]" />
        {/* spring positioned relative to screen3 */}
        <Image src={"/pencil_spring.png"} alt={"spring"} height={100} width={4000} className="w-[18vh] h-[17vh] absolute top-[7vh] right-[-9vh]" />
      </div>
    </div>
  </div>
  {/* images end */}
